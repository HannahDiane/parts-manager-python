...
# Part
part_text = StringVar()
part_label = Label(app, text='Part Name', font=('normal', 14), pady=20)
...
customer_label = Label(app, text='Customer', font=('normal', 14))
...
retailer_label = Label(app, text='Retailer', font=('normal', 14))
...
price_label = Label(app, text='Price', font=('normal', 14))
